...
/**Damit dieser Fehler weg geht
 * Deprecated: Creation of dynamic property View::$users is deprecated
 * in C:\xampp\htdocs\PandorasKitchen\application\core\View.php on line 20
 */
...
class View
{
     ...
     * $this->view->render('help/index'); to show (in this example) the view whiz.php in the folder help.
